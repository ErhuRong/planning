...
(defvar *current-nonlin-version*      "1.2.2")
(defvar *current-nonlin-version-date* "11/92")

(defparameter *nonlin-debug-options* 
   '((:allnodes "Current Task Network") (:taskqueue "Current Task Queue") (:tome "Table of Multiple Effects")
     (:gost "Goal Structure Table") (:plan "Current Plan") (:plan-brief "Current Plan (brief)")
     (:schema "Schema Expansion Info") 
     (:back "Backtracking Info")
     (:expand "Node Expansion Info") 
     (:link "Node Linearization Info")
))
